...
struct command_info cmd_info[] =
  {
    ...
    { "addpoint" , POS_DEAD    , do_wizutil  , LVL_FIXER, SCMD_POWERPOINT },
    ...
    { "banname"  , POS_DEAD    , do_ban_name , LVL_EXECUTIVE, 0},
    ...
    { "finger"   , POS_LYING   , do_last     , 0, SCMD_FINGER },
    { "fix"  , POS_STANDING, do_repair   , 0, 0 },
    ...
    { "glist"    , POS_RESTING , do_glist    , LVL_PRESIDENT, 0 },
    ...
    { "idelete"  , POS_DEAD    , do_idelete  , LVL_BUILDER, 0 },
    ...
    { "initiate" , POS_DEAD    , do_wizutil  , LVL_FIXER, SCMD_INITIATE },
    ...
    { "load"     , POS_RESTING , do_wizload  , LVL_ADMIN, 0 },
    ...
    { "manifest" , POS_DEAD    , do_manifest , 0, 0 },
    { "mellow"   , POS_RESTING , do_action   , 0, 0 },
    { "mclone"   , POS_DEAD    , do_mclone   , LVL_BUILDER, 0},
    { "mdelete"  , POS_DEAD    , do_mdelete  , LVL_BUILDER, 0},
    ...
    { "pg"       , POS_DEAD    , do_wizutil  , LVL_EXECUTIVE, SCMD_PG },
    ...
    { "rdelete"  , POS_DEAD    , do_rdelete  , LVL_BUILDER, 0},
    ...
    { "switch"   , POS_DEAD    , do_switch   , LVL_FIXER, 0 },
    ...
    { "unoperate", POS_RESTING , do_unoperate, LVL_EXECUTIVE, 0 },
    { "unpack"   , POS_SITTING , do_unpack   , 0, 0 },
    { "unsubscribe",POS_RESTING, do_subscribe, 0, SCMD_UNSUB },
    { "upgrade"  , POS_STANDING, do_upgrade, 0 , 0 },
    ...
    { "zdelete"  , POS_DEAD    , do_zdelete  , LVL_ADMIN, 0 },
...
char *delete_doubledollar(char *string)
{
  ...
  if ((write = strchr((char *)string, '$')) == NULL)
    return string;
...
void nanny(struct descriptor_data * d, char *arg)
{
  ...
  case CON_GET_NAME:            /* wait for input of name */
    ...
    if (!*arg) {
      ...
      if (playerDB.DoesExist(tmp_name)) {
    ...
    case '1':
      ...
      if (load_result == 2) {   /* rented items lost */
        send_to_char("\r\n\007You could not afford your rent!\r\n"
                     "Your possessions have been donated to the "
                     "Salvation Army!\r\n",
                     d->character);
      }
      d->prompt_mode = 1;
  ...
  case CON_QDELCONF2:
    if (!strcmp(arg, "yes") || !strcmp(arg, "YES")) {
      ...
      if (!playerDB.DeleteChar(GET_IDNUM(d->character)))
        log("--Error: could not delete PC %s", GET_CHAR_NAME(d->character));
