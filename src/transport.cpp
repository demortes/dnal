...
static struct dest_data destinations[] =
  {
    ...
    { "knight", "Knight Center", 1519, 3, SOUTH},
    { "afterlife", "The Afterlife", 2072, 3, SOUTH },
    { "chinatown", "ChinaTown", 2527, 3, SOUTH },
    { "evergreen", "Evergreen Complex", 2201, 3, SOUTH },
    { "twe", "Tacoma Weapons Emporium", 2514, 3, SOUTH },
    { "nybbles", "Nybbles and Bytes", 2057, 3, SOUTH },
    { "biohyde", "Biohyde Complex", 4201, 1, NORTHWEST },
    { "puyallup", "Central Puyallup", 2457, 5, SOUTH },
    { "park", "Seattle State Park", 4000, 0, NORTH },
    { "seattle", "Seattle", 32679, 1, NORTH },
    { "cinema", "Le Cinema Vieux", 32588, 1, NORTH },
    { "vieux", "Le Cinema Vieux", 32588, 1, NORTH },
    { "charne", "La Charne", 30548, 1, NORTH },
    { "tarislar", "Tarislar", 4965, 6, SOUTH },
    { "wyvern", "The Blue Wyvern", 4909, 6, NORTH },
    ...
    { "epicenter", "The Epicenter", 2418, 5, SOUTH },
    { "yoshi", "Yoshi's Sushi Bar", 32751, 1, NORTHWEST },
    { "airport", "Seattle-Tacoma Airport", 19410, 2, SOUTH },
    ...
    { "sda", "The SDA Plaza", 30610, 1, NORTHEAST },
    ...
    { "methodist", "Seattle First Methodist", 30565, 1, NORTHWEST },
    { "sculleys", "Sculleys", 30591, 1, NORTHWEST },
    { "council", "Council Island", 9149, 4, SOUTHWEST },
    { "moonlight", "Moonlight Mall", 14373, 4, NORTH },
    { "library", "Seattle Public Library", 30600, 1, NORTH },
    { "kristins", "Kristin's", 30578, 1, NORTHWEST },
    { "mitsuhama", "Mitsuhama Towers", 32722, 1, NORTHEAST },
    { "chiba", "Little Chiba", 32686, 1, NORTHEAST },
    { "stop", "The Stop Gap", 32708, 1, SOUTHEAST },
    { "apartment", "Redmond Apartment Block", 14337, 4, SOUTHWEST },
    { "humana", "Humana Hospital", 2536, 3, SOUTH },
    { "hospital", "Council Island Hospital", 9161, 4, WEST },
    { "coffin", "Tacoma Coffin Hotel", 2045, 1, SOUTH },
    { "diver", "Easy Diver Coffin Hotel", 32644, 1, WEST },
    { "action", "Action Computers", 32650, 1, WEST },
    { "auburn", "Auburn", 1350, 2, NORTH },
    { "hellhound", "Hellhound Bus Stop",  32501, 1, NORTHWEST },
    { "lysleul", "Lysleul Plaza", 30551, 1, NORTH },
    { "microdeck", "Auburn Microdeck Outlet", 29010, 2, NORTH },
    { "novatech", "Novatech Seattle", 32541, 1, NORTHWEST },
    { "syberspace", "SyberSpace", 30612, 1, NORTHEAST },
    { "pooks", "Pook's Place", 1530, 3, EAST },
    { "errant", "KE Training Facility", 30127, 3, NORTH },
    { "italiano", "The Italiano", 30149, 3, NORTH },
    { "bank", "UCASBank", 30524, 0, 0 },
    { "matchsticks", "Matchsticks", 30579, 0, 0 },
    { "homewood", "Homewood Suites", 30512, 0, 0 },
